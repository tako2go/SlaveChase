...
public class charactor : MonoBehaviour
{
    ...
    void Move()
    {
        ...
        if (ActionFlag && !flyFlag)//�W�����v�ȊO�ŃA�N�V�����������瑫���~�߂�
        {
            MoveFlag = false;
            RunFlag = false;
        }
    ...
    void Jump()
    {
        ...
        if (Input.GetKey(KeyCode.Space) == true)
        {
            ...
            {
                JumpFlag = true;
                UpDownSpeed = JumfirstSpeed;//�����x�̒ǉ�
                this.transform.Translate(0, 0.1f, 0);//FlyFlag����u��false�ɂȂ邱�Ƃ�h�~
    ...
    void Fly()
    {
        if (CurrentlyFlyFlag)//�O��t���[����false�Ȃ��Fly���Ă���Ƃ݂Ȃ�
        {
            flyFlag = false;
        }
        else
        ...
        if (flyFlag)
        {
            UpDownSpeed += Gravity * Time.deltaTime;//�����x�𑫂�
        }
        //ActionFlag |= flyFlag;
    }
    ...
    //    if (AttackFlag)
    //    {
    //        AttackTimePro += Time.deltaTime;//�U�����n�߂���̎��Ԍo��
    //        if (AttackTimePro >= AttackTime)//�o�ߎ��Ԃ��ݒ莞�Ԃ𒴂�����U���I��
    //        {
    //            AttackFlag = false;
    ...
    //    if(AttackFlag == true)//�U�����[�V��������
    //    {
    //        if(swordCollision.SwordCollisionFlag == true)//�����U��������������
    //        {
    //            if(CollisionFirstFlag == false)//�ŏ��̈�񂾂�
    //            {
    //                enemyAgent.DamageEnemy(5);//enemyAgent.DamageEnemy(2);//�G�̗̑͂�����֐����s
    ...
    void ItemChange()
    {
        if (!attackSctipt.ChargeFlag && !AttackFlag)//�U���A�U���`���[�W���̓_��
        {
